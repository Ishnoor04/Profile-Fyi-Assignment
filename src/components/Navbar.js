    ...
    >
      <div className="header-row flex justify-between items-center px-6 md:px-10 ">
        <div className="brand-logo flex items-center justify-center">
          <Link href="/products">
            <h5 className="mt-2 lg:text-[32px] md:text-[28px] xs:text-[24px] text-[20px] font-bold tracking-tight text-black font-allura">
              E-Shop
            </h5>
          </Link>
        </div>
          ...
          >
            {totalQuantity > 0 && (
              <svg
                ...
                className="lg:w-[62px] lg:h-[62px] md:h-[54px] md:w-[54px] xs:h-[50px] xs:w-[50px] h-[44px] w-[44px]"
                viewBox="0 0 32 24"
              >
            ...
            <p className="text-black absolute top-[-24%] right-[40%] lg:text-[26px]  rounded-full p-1">
              {totalQuantity}
            </p>
          </button>
        </Link>
        {user ? (
          ...
          <div className="flex flex-row justify-center gap-1">
            <Link href="signup">
              {" "}
              <div className={`ss:text-[18px] text-[12px] lg:text-[24px] xs:p-2 p-1 hover:underline border-r-2 border-black text-center`}>
                Signup
              </div>
            </Link>
            <Link href="login">
              {" "}
              <div className=" ss:text-[18px] text-[12px] lg:text-[24px] xs:p-2 p-1 hover:underline">Login</div>
            </Link>
          </div>
        )}
      </div>
